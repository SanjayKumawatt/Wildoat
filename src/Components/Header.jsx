      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden lg:flex items-center space-x-6">
            <Link to={"/"} className='text-gray-700 text-sm font-semibold transition-colors duration-200 '>
              Home
            </Link>

            <Link to={"/about"} className='text-gray-700 pl-4 pr-4 text-sm font-semibold transition-colors duration-200 '>
              About Us
            </Link>
            ...
            {navItems.map((category) => (
              ...
              >
                ...
                {/* Dropdown Menu */}
                {activeDropdown === category.title && (
                  <div className="absolute left-1/2 transform -translate-x-1/2  w-[600px] bg-white rounded-xl shadow-xl border border-gray-100 overflow-hidden ring-1 ring-black ring-opacity-5 animate-in fade-in slide-in-from-top-2 duration-200">
            ...
            <Link to={"/contact"} className='text-gray-700  text-sm font-semibold transition-colors duration-200 '>
              Contact Us
            </Link>
