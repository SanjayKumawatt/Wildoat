...
import { 
  ArrowRight, Monitor, Cloud, Database, 
  Network, Code2, Server, Settings, CheckCircle 
} from 'lucide-react';

import img1 from "../assets/uiux/img1.gif";
import img2 from "../assets/uiux/img3.avif";
...
const SoftwareDevelopment = () => {
  ...
  // Data extraction from Image (Software Services Grid)
  const softwareServices = [
    {
      title: "Custom Web Apps",
      desc: "Full-stack apps with modern frameworks and robust APIs.",
      icon: <Monitor className="w-6 h-6" />,
      points: ["React/Next.js", "Node.js/NestJS", "REST/GraphQL", "CI/CD Pipelines"]
    },
    {
      title: "Mobile Apps",
      desc: "iOS/Android apps with seamless UX and high performance.",
      icon: <ArrowRight className="w-6 h-6 rotate-[-45deg]" />, // Using arrow as generic app icon or replace with Smartphone
      points: ["React Native", "Expo", "Native Modules", "App Store/Play Release"]
    },
    {
      title: "SaaS/Microservices",
      desc: "Cloud-native architectures built to scale globally.",
      icon: <Cloud className="w-6 h-6" />,
      points: ["Docker/Kubernetes", "Event-driven", "Multi-tenancy", "Observability"]
    },
    {
      title: "Integrations & APIs",
      desc: "Secure integrations with third-party services and legacy systems.",
      icon: <Network className="w-6 h-6" />,
      points: ["OAuth2/SAML", "Webhooks", "API Gateways", "Rate Limiting"]
    },
    {
      title: "Quality & Testing",
      desc: "Automated tests and QA to ensure reliability and uptime.",
      icon: <CheckCircle className="w-6 h-6" />,
      points: ["Unit/E2E Tests", "Performance Tests", "Static Analysis", "Load Testing"]
    },
    {
  ...
  const partners = [
    ...
    "https://upload.wikimedia.org/wikipedia/commons/0/05/Go_Logo_Blue.svg", // Go (Common in backend)
    "https://upload.wikimedia.org/wikipedia/commons/c/c3/Python-logo-notext.svg",
    "https://upload.wikimedia.org/wikipedia/commons/2/29/Postgresql_elephant.svg", // Postgres
  ...
  return (
    <div className="bg-white pt-20">
        ...
        <div className="flex flex-col lg:flex-row items-center gap-12">
          <div className="flex-1 text-left z-10">
            ...
            <p className="text-lg text-gray-600 mb-8 leading-relaxed max-w-xl">
              Welcome to <span className="font-bold text-black">WILDOAT TECH</span>, your trusted software development partner. We create custom software solutions, enterprise applications, and scalable systems that streamline operations and accelerate business growth.
            </p>
      ...
      {/* 3. Feature Section (Zig Zag - Image Right) */}
        ...
        <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-24">
          ...
          <div className="flex-1">
            <span className="text-xs font-bold text-gray-400 uppercase tracking-widest mb-3 block">
              BUILD SCALABLE SOFTWARE SOLUTIONS FOR YOUR BUSINESS!
            </span>
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
              Software Development
            </h2>
            <p className="text-gray-600 leading-relaxed mb-6">
              Unlock the potential of custom software solutions with <span className="font-semibold text-black">Wildoat Tech</span>. Our dedicated team of software engineers excels in creating enterprise-grade applications, scalable systems, and innovative software products that streamline operations.
            </p>
            <p className="text-gray-600 leading-relaxed mb-8">
              From system architecture to deployment, we transform your vision into robust software solutions. Partner with us and elevate your project to new heights with our expertise and creativity in software development.
            </p>
      ...
      <section className="bg-gray-50 py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold text-gray-900">Our Software Development Services</h2>
